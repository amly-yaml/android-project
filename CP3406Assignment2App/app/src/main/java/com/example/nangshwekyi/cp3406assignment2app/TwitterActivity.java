...
public class TwitterActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void initTwitterConfigs() {
        consumerKey = "UhGBIrkvzclklQ11CR7q7t7IT";
        consumerSecret = "25k8qjkBjRX9pkB7mnUgl7goRgQ7iaqvGryQwPFQH28VVjan4j";
    ...
    private void loginToTwitter() {
        ...
        if (!isLoggedIn) {
            ...
            try {
                ...
                final Intent intent = new Intent(this, Authenticate.class);
                intent.putExtra(Authenticate.EXTRA_URL, requestToken.getAuthenticationURL());
    ...
    class updateTwitterStatus extends AsyncTask<String, String, Void> {
        ...
        protected Void doInBackground(String... args) {
            ...
            try {
                ...
                InputStream is = getResources().openRawResource(+ R.drawable.first_image);
